...
Route::group(['namespace' => 'App\Http\Controllers\Frontend', 'as' => 'frontend.'], function () {
    ...
    Route::get('gonderi-takip', 'CargoTrackController@index')->name('gonderi-takip');
    Route::post('gonderi-takip-sonuc', 'CargoTrackController@sorgula')->name('gonderi-sorgula');
    Route::get('sorgulamaalani/{kod}', 'CargoTrackController@sorgu1')->name('sorgu1');
    Route::get('biz-kimiz', 'FrontendController@who')->name('who');
    Route::get('cerez-politikasi', 'FrontendController@cerez')->name('cerez');
    Route::get('hemen-teklif-al', 'FrontendController@hizliteklif')->name('hizliteklif');
    Route::get('destek', 'FrontendController@destek')->name('destek');
    Route::get('iletisim', 'FrontendController@iletisim')->name('iletisim');
    Route::get('kvkk', 'FrontendController@kvkk')->name('kvkk');
    Route::get('subelerimiz', 'FrontendController@subeler')->name('subeler');
...
* --------------------------------------------------------------------
*/
Route::group(['namespace' => 'App\Http\Controllers\Backend', 'prefix' => 'yonetimx', 'as' => 'backend.', 'middleware' => ['auth', 'can:view_backend']], function () {
